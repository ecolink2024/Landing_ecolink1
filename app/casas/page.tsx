    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-eco-beige">
      ...
      <section className="relative h-[560px] flex items-end overflow-hidden">
        ...
        <div className="container mx-auto px-6 pb-12 relative z-10">
          <p className="text-white/80 text-xs font-bold uppercase tracking-[0.2em] mb-2">Casas</p>
      ...
      <section className="relative h-[400px] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-4xl">
          ...
          <p className="text-white/90 text-base md:text-lg leading-relaxed max-w-2xl">
            También podés optar por llevar tu Bolsa EcoLink llena a nuestra red de Puntos EcoLink y adquirir una nueva.
          </p>
        </div>
      </section>
