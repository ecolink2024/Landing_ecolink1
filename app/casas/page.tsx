          ...
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-12">
              <span className="text-eco-green italic">
                NUESTROS INSUMOS FUERON DISEÑADOS PARA BRINDARTE COMODIDAD Y
                HACERTELA FACIL
              </span>
            </h2>
        ...
        <section className="relative h-[400px] flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
              alt="Red aliada"
              className="w-full h-full object-cover"
              src="/CasasLocales.png"
            />
            <div className="absolute inset-0 bg-black/50"></div>
          </div>
          <div className="container mx-auto px-6 relative z-10 max-w-4xl">
            <h2 className="text-white text-3xl md:text-4xl font-extrabold mb-4">
              EcoLink en tu barrio | Red aliada
            </h2>
            <p className="text-white/90 text-base md:text-lg leading-relaxed max-w-2xl">
              También podés optar por llevar tu Bolsa EcoLink llena a nuestra
              red de Puntos EcoLink y adquirir una nueva.
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2">
            <div className="flex items-center justify-center px-10 py-20">
              <h2 className="text-white text-3xl md:text-4xl font-extrabold leading-tight max-w-md">
                ¡Encontrá tu Punto más cercano para intercambiar tu bolsa llena
                por una nueva!
              </h2>
            </div>
          ...
          <div className="container mx-auto grid md:grid-cols-2 gap-12 max-w-6xl">
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Hacé click para contactarnos, o dejanos tu consulta y te
                contactamos
              </p>
              <div>
                <a
