      ...
      <main>
        ...
        <section className="bg-eco-beige py-16 md:py-24 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-eco-green text-3xl font-extrabold mb-4">
              Trazamos decisiones
            </h2>
            <p className="text-eco-forest mb-16 max-w-2xl mx-auto leading-relaxed">
              Desde la separación en origen, hasta las cooperativas de
              reciclaje, acompañamos a Empresas, Hogares y Organizaciones en una
              Gestión Consciente de sus residuos.
            </p>
            <img
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {news.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-eco-beige/60 text-lg">
        ...
        <section className="bg-eco-forest py-16 md:py-24 px-4 sm:px-6 text-center text-eco-beige">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold leading-tight">
              El futuro se construye con las decisiones que tomamos{" "}
              <span className="italic font-extrabold text-white">HOY</span>
            </h2>
          </div>
        </section>
        ...
        <section
          id="contacto"
          className="bg-eco-beige py-16 md:py-24 px-4 sm:px-6 scroll-mt-24"
        >
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
            <div>
              ...
              <p className="text-eco-forest text-lg font-medium">
                Déjanos tu consulta y ayudanos.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              >
                ...
                <button
                  className="w-full bg-eco-pink text-white font-bold py-4 rounded-md hover:bg-opacity-90 transition-all uppercase tracking-widest text-sm"
                  type="submit"
                >
                  Enviar
                </button>
